...
import type { TrialRegistration } from "~/schemas/trial.schema"
import { SchoolClasses } from "~/types"

const state = defineModel<TrialRegistration>({ required: true })

defineProps<{ schema: unknown }>()

const emit = defineEmits<{
    submit: [event: FormSubmitEvent<TrialRegistration>]
}>()
