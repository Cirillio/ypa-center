...
<template>
    <div class="bg-default flex flex-col gap-2.5 rounded-lg p-4">
        <!-- Header -->
        <div class="flex items-center justify-between gap-2">
            <div class="flex items-center gap-2">
                ...
                <span class="text-default/90 text-sm font-semibold tracking-wider uppercase">
                    {{ typeConfig[item.type].label }}
                </span>
            </div>
            <span v-if="item.metaLabel" class="text-default/40 text-[10px] font-bold uppercase">
                {{ item.metaLabel }}
            </span>
        </div>
        ...
        <div class="flex items-center gap-2">
            ...
            <span class="text-default truncate text-lg font-bold">{{ item.participant }}</span>
        </div>
