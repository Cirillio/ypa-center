    ...
    <div class="bg-default relative overflow-hidden rounded-lg p-4">
        ...
        <div class="flex flex-col gap-4" :class="{ 'opacity-75': isPast }">
            <div class="flex items-center gap-4">
                <div
                    class="flex items-center justify-center rounded-full bg-cyan-500/5 p-2.5 text-cyan-500"
                >
                    <UIcon name="ph:calendar-blank-bold" class="size-6" />
                </div>
                <div class="grid">
                    <h3 class="text-default/75 text-base leading-tight">Пробное занятие</h3>
